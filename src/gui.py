...
class MainScreen(tk.Frame):
    ...
    def update(self):
        ...
        createIdentityButton.grid(row=2, column=0, sticky="NESW")
        mineBlockButton.grid(row=3, column=0, sticky="NESW")
        scanImageButton.grid(row=4, column=0, sticky="NESW")
        checkLedgerIntegrityButton.grid(row=5, column=0, sticky="NESW")
        showActiveConnsButton.grid(row=6, column=0, sticky="NESW")
